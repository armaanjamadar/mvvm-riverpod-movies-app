      ...
      body: Consumer(builder: (context, WidgetRef ref, child) {
        ...
        if (movieState.isLoading && movieState.moviesList.isEmpty) {
          ...
          return Padding(
            ...
            child: Center(child: Text(movieState.fetchMoviesError, textAlign: TextAlign.center)),
          );
        }
        return NotificationListener<ScrollNotification>(
          onNotification: (ScrollNotification scrollInfo) {
            if (scrollInfo.metrics.pixels == scrollInfo.metrics.maxScrollExtent && !movieState.isLoading) {
